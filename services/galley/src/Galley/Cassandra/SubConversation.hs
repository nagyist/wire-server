...
deletePublicGroupStateDB :: ConvId -> SubConvId -> Client ()
deletePublicGroupStateDB convId subConvId =
...
interpretSubConversationStoreToCassandra = interpret $ \case
  ...
  DeletePublicGroupState convId subConvId -> embedClient $ deletePublicGroupStateDB convId subConvId
